...
const scannerCandidatesRouter = require('./routes/scannerCandidates');
const statusRouter = require('./routes/status');
const adminStatusRouter = require('./routes/adminStatus');
const adminChainRouter = require('./routes/adminChain');
...
const { router: technicalLevelsRouter } = require('./routes/technicalLevels');
...
app.use('/api/v1/scanner', requireEntitlement('scanner'), scannerCandidatesRouter);
app.use('/api/scanner', requireEntitlement('scanner'), ledgerRouter);
app.use('/api/status', statusRouter);
app.use('/api/admin/status', adminStatusRouter);
app.use('/api/admin/chain', adminChainRouter);
...
app.use('/api/news', requireEntitlement('live_analysis'), newsRouter);
...
app.use('/api/technical-levels', requireEntitlement('live_analysis'), technicalLevelsRouter);
