export default function Sec5Playbook({ data }) {
  ...
  if (!scenarios) return <div className="az-card"><div className="az-card-title">条件情景暂不可用</div><p>当前没有足够的关键价位信息。</p></div>;
  return (
    <div className="wk-section">
      ...
      <div className="wk-play-disclaimer">这些情景仅用于研究观察，不构成交易指令或投资建议。</div>
    </div>
  );
}
