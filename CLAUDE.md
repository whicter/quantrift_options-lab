...
docs/                  ← Canonical long-form docs (task.md, wiki.md, learning.md, etc.)
frontend/src/
...
- `/api/technical-levels/:symbol` is the expanded Technical Confluence product. Keep GEX Wall and OI Wall distinct, preserve component-level missing states, and do not mark it production-ready until Railway and Vercel acceptance in `docs/task.md` is complete.
