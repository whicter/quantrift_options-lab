...
- [ ] 订阅分层: 免费（教育工具）/ 付费（scanner + alerts + live data）
  ...
  - [ ] 将 scanner/alerts/live routes 接入 entitlement enforcement（待 Stripe section 一并完成）
- [x] Portfolio dashboard：Clerk-owned CRUD、multi-leg positions、真实 contract snapshot mark、未实现 P/L 与 aggregate Delta/Gamma/Theta/Vega（2026-07-15）
