...
| `/analyze` | V2 标的分析：真实价格趋势、S/R、Volume Profile、Focus Score、GEX、VRP、IV skew 与期限结构 |
...
- Analyze computes direction context from real price history and displays Focus Score, VRP, Gamma Flip, Local Gamma, S/R, 30M Volume Profile, IV skew and term structure. Strategy legs remain hidden until an actual contract candidate is attached.
