...
| G3 | **没有板块/轮动视图**。universe 元数据里有 sector 字段但没有任何聚合页面；没有 breadth | nextpick RRG、alphastockpro 板块分+Breadth | 🟡 |
...
- **R2.2 Breadth 模块**:% of universe above MA50/200 + 期权原生市场体征
  (% 正 Gamma、IV Rank 中位数、PCR 分布)——这是三家都没有的"期权版 breadth"。
